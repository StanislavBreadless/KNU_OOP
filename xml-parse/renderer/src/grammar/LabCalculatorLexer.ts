...
export class LabCalculatorLexer extends Lexer {
  ...
  // @ts-ignore
	...
	public static readonly _serializedATN: string =
		"\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02\x0FK\b\x01\x04" +
		"\x02\t\x02\x04\x03\t\x03\x04\x04\t\x04\x04\x05\t\x05\x04\x06\t\x06\x04" +
		"\x07\t\x07\x04\b\t\b\x04\t\t\t\x04\n\t\n\x04\v\t\v\x04\f\t\f\x04\r\t\r" +
		"\x04\x0E\t\x0E\x03\x02\x03\x02\x03\x02\x05\x02!\n\x02\x03\x03\x06\x03" +
		"$\n\x03\r\x03\x0E\x03%\x03\x03\x06\x03)\n\x03\r\x03\x0E\x03*\x03\x04\x06" +
		"\x04.\n\x04\r\x04\x0E\x04/\x03\x05\x03\x05\x03\x06\x03\x06\x03\x07\x03" +
		"\x07\x03\b\x03\b\x03\t\x03\t\x03\t\x03\t\x03\n\x03\n\x03\n\x03\n\x03\v" +
		"\x03\v\x03\f\x03\f\x03\r\x03\r\x03\x0E\x03\x0E\x03\x0E\x03\x0E\x02\x02" +
		"\x02\x0F\x03\x02\x03\x05\x02\x04\x07\x02\x05\t\x02\x06\v\x02\x07\r\x02" +
		"\b\x0F\x02\t\x11\x02\n\x13\x02\v\x15\x02\f\x17\x02\r\x19\x02\x0E\x1B\x02" +
		"\x0F\x03\x02\x05\x04\x02C\\c|\x03\x022;\x05\x02\v\f\x0F\x0F\"\"\x02N\x02" +
		"\x03\x03\x02\x02\x02\x02\x05\x03\x02\x02\x02\x02\x07\x03\x02\x02\x02\x02" +
		"\t\x03\x02\x02\x02\x02\v\x03\x02\x02\x02\x02\r\x03\x02\x02\x02\x02\x0F" +
		"\x03\x02\x02\x02\x02\x11\x03\x02\x02\x02\x02\x13\x03\x02\x02\x02\x02\x15" +
		"\x03\x02\x02\x02\x02\x17\x03\x02\x02\x02\x02\x19\x03\x02\x02\x02\x02\x1B" +
		"\x03\x02\x02\x02\x03\x1D\x03\x02\x02\x02\x05#\x03\x02\x02\x02\x07-\x03" +
		"\x02\x02\x02\t1\x03\x02\x02\x02\v3\x03\x02\x02\x02\r5\x03\x02\x02\x02" +
		"\x0F7\x03\x02\x02\x02\x119\x03\x02\x02\x02\x13=\x03\x02\x02\x02\x15A\x03" +
		"\x02\x02\x02\x17C\x03\x02\x02\x02\x19E\x03\x02\x02\x02\x1BG\x03\x02\x02" +
		"\x02\x1D \x05\x07\x04\x02\x1E\x1F\x070\x02\x02\x1F!\x05\x07\x04\x02 \x1E" +
		"\x03\x02\x02\x02 !\x03\x02\x02\x02!\x04\x03\x02\x02\x02\"$\t\x02\x02\x02" +
		"#\"\x03\x02\x02\x02$%\x03\x02\x02\x02%#\x03\x02\x02\x02%&\x03\x02\x02" +
		"\x02&(\x03\x02\x02\x02\')\t\x03\x02\x02(\'\x03\x02\x02\x02)*\x03\x02\x02" +
		"\x02*(\x03\x02\x02\x02*+\x03\x02\x02\x02+\x06\x03\x02\x02\x02,.\x042;" +
		...
		"4\f\x03\x02\x02\x0256\x071\x02\x026\x0E\x03\x02\x02\x0278\x07/\x02\x02" +
		"8\x10\x03\x02\x02\x029:\x07f\x02\x02:;\x07k\x02\x02;<\x07x\x02\x02<\x12" +
		"\x03\x02\x02\x02=>\x07o\x02\x02>?\x07q\x02\x02?@\x07f\x02\x02@\x14\x03" +
		"\x02\x02\x02AB\x07-\x02\x02B\x16\x03\x02\x02\x02CD\x07*\x02\x02D\x18\x03" +
		"\x02\x02\x02EF\x07+\x02\x02F\x1A\x03\x02\x02\x02GH\t\x04\x02\x02HI\x03" +
		"\x02\x02\x02IJ\b\x0E\x02\x02J\x1C\x03\x02\x02\x02\x07\x02 %*/\x03\x02" +
		"\x03\x02";

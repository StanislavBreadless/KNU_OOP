...
export class LabCalculatorLexer extends Lexer {
	...
	public static readonly _serializedATN: string =
		...
		"\x0E\x04,\x03\x05\x03\x05\x03\x06\x03\x06\x03\x07\x03\x07\x03\b\x03\b" +
		"\x03\t\x03\t\x03\n\x03\n\x03\v\x03\v\x03\f\x03\f\x03\f\x03\f\x02\x02\x02" +
		"\r\x03\x02\x03\x05\x02\x04\x07\x02\x05\t\x02\x06\v\x02\x07\r\x02\b\x0F" +
		"\x02\t\x11\x02\n\x13\x02\v\x15\x02\f\x17\x02\r\x03\x02\x06\x04\x02C\\" +
		"c|\x03\x023;\x03\x022;\x05\x02\v\f\x0F\x0F\"\"\x02C\x02\x03\x03\x02\x02" +
		"\x02\x02\x05\x03\x02\x02\x02\x02\x07\x03\x02\x02\x02\x02\t\x03\x02\x02" +
		"\x02\x02\v\x03\x02\x02\x02\x02\r\x03\x02\x02\x02\x02\x0F\x03\x02\x02\x02" +
		"\x02\x11\x03\x02\x02\x02\x02\x13\x03\x02\x02\x02\x02\x15\x03\x02\x02\x02" +
		"\x02\x17\x03\x02\x02\x02\x03\x19\x03\x02\x02\x02\x05\x1F\x03\x02\x02\x02" +
		"\x07*\x03\x02\x02\x02\t.\x03\x02\x02\x02\v0\x03\x02\x02\x02\r2\x03\x02" +
		"\x02\x02\x0F4\x03\x02\x02\x02\x116\x03\x02\x02\x02\x138\x03\x02\x02\x02" +
		"\x15:\x03\x02\x02\x02\x17<\x03\x02\x02\x02\x19\x1C\x05\x07\x04\x02\x1A" +
		"\x1B\x070\x02\x02\x1B\x1D\x05\x07\x04\x02\x1C\x1A\x03\x02\x02\x02\x1C" +
		"\x1D\x03\x02\x02\x02\x1D\x04\x03\x02\x02\x02\x1E \t\x02\x02\x02\x1F\x1E" +
		"\x03\x02\x02\x02 !\x03\x02\x02\x02!\x1F\x03\x02\x02\x02!\"\x03\x02\x02" +
		"\x02\"#\x03\x02\x02\x02#%\t\x03\x02\x02$&\t\x04\x02\x02%$\x03\x02\x02" +
		"\x02&\'\x03\x02\x02\x02\'%\x03\x02\x02\x02\'(\x03\x02\x02\x02(\x06\x03" +
		"\x02\x02\x02)+\x042;\x02*)\x03\x02\x02\x02+,\x03\x02\x02\x02,*\x03\x02" +
		"\x02\x02,-\x03\x02\x02\x02-\b\x03\x02\x02\x02./\x07`\x02\x02/\n\x03\x02" +
		"\x02\x0201\x07,\x02\x021\f\x03\x02\x02\x0223\x071\x02\x023\x0E\x03\x02" +
		"\x02\x0245\x07/\x02\x025\x10\x03\x02\x02\x0267\x07-\x02\x027\x12\x03\x02" +
		"\x02\x0289\x07*\x02\x029\x14\x03\x02\x02\x02:;\x07+\x02\x02;\x16\x03\x02" +
		"\x02\x02<=\t\x05\x02\x02=>\x03\x02\x02\x02>?\b\f\x02\x02?\x18\x03\x02" +
		"\x02\x02\x07\x02\x1C!\',\x03\x02\x03\x02";
